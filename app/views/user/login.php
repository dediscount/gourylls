				...
				<form class="" onsubmit="#" action="" method="POST" role="form">
					<div class="modal-body">
						<div class="input-group-login">
							<input type="text" name="input-account" id="inputInput-Account" class="form-control" placeholder="Enter your account..." required="required" pattern="" title="Enter your account">
							<br/>
