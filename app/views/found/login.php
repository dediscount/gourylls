	...
	<div class="modal-dialog">
		<!--validate and submit-->
			...
			<div class="modal-content">
				...
				<form class="" onsubmit="return login();" role="form">
					<div class="modal-body">
						<div class="input-group-login">
							<div class="form-group has-feedback">
							<input type="text" name="input-account" id="inputInput-Account" class="form-control" placeholder="Enter your email..." pattern="^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+" required="required"   title="Enter your account">
